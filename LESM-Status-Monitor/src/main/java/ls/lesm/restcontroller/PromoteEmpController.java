...
public class PromoteEmpController {
	...
	@Autowired
	GetSameDesignations getSameDesignation;
...
List<MasterEmployeeDetails>  getSameDesignationEmployees(@PathVariable int id)
{
	...
	List<MasterEmployeeDetails> EmployeeDetails=getSameDesignation.getSameDesignations(id);
...
String promoteEmployeeDetail(@PathVariable int id,@PathVariable int id2)
{
	getSameDesignation.promoteEmployeeDetails(id, id2);
